...
DEFAULT_PC_SETTINGS = {
    ...
    "selectorJson" : r'C:/Users/keena/Desktop/Milivault/credentials/militaria_selectors.json',
...
def setup_object_managers(user_settings):
    try:
        return {
            "dataManager"     : PostgreSQLProcessor(credFile=user_settings["pgAdminCred"]),
            "s3_manager"      : S3Manager(user_settings["s3Cred"]),
            "webScrapeManager": ProductScraper(PostgreSQLProcessor(user_settings["pgAdminCred"])),
